...
class Ui_RegistrationWindow(object):
    def setupUi(self, RegistrationWindow):
        ...
        self.entry_button = QtWidgets.QPushButton(RegistrationWindow)
        self.entry_button.setGeometry(QtCore.QRect(90, 150, 221, 31))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../../../../../.designer/static/vk_logo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.entry_button.setIcon(icon)
        self.entry_button.setIconSize(QtCore.QSize(20, 20))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../../../../../../.designer/static/crossed_eye.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.mail_icon.setPixmap(QtGui.QPixmap("../../../../../../.designer/static/mail.png"))
        ...
        self.password_icon.setPixmap(QtGui.QPixmap("../../../../../../.designer/static/password.png"))
    ...
    def retranslateUi(self, RegistrationWindow):
        ...
        self.entry_button.setText(_translate("RegistrationWindow", "Войти"))
