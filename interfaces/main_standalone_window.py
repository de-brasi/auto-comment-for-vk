...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.AccountsManagmentGroup.setFrameShape(QtWidgets.QFrame.StyledPanel)
        ...
        self.accounts_list_display.addItem("")
        self.accounts_list_display.addItem("")
        self.accounts_list_display.addItem("")
        self.frame = QtWidgets.QFrame(self.AccountsManagmentGroup)
        self.frame.setGeometry(QtCore.QRect(10, 10, 191, 111))
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.add_account_button = QtWidgets.QPushButton(self.frame)
        self.add_account_button.setGeometry(QtCore.QRect(20, 50, 141, 41))
        self.add_account_button.setObjectName("add_account_button")
        self.accounts_frame_description = QtWidgets.QLabel(self.frame)
        self.accounts_frame_description.setGeometry(QtCore.QRect(0, 10, 111, 41))
        self.accounts_frame_description.setObjectName("accounts_frame_description")
        self.accounts_counter = QtWidgets.QLabel(self.frame)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.accounts_list_display.setItemText(0, _translate("MainWindow", "1"))
        self.accounts_list_display.setItemText(1, _translate("MainWindow", "2"))
        self.accounts_list_display.setItemText(2, _translate("MainWindow", "3"))
        self.add_account_button.setText(_translate("MainWindow", "Добавить аккаунт"))
        self.accounts_frame_description.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\">Аккаунты VK:</p></body></html>"))
